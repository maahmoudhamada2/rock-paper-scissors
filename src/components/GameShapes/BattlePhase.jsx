...
export default function BattlePhase() {
  ...
  return (
    <div className="w-full self-start flex flex-wrap content-between justify-evenly gap-x-[10vw] gap-y-[7vw] md:justify-center md:h-auto md:flex-nowrap md:gap-[2rem]">
