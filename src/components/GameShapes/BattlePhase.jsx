...
export default function BattlePhase() {
  ...
  return (
    <div className="h-[56vh] sm:h-[60vh] flex flex-wrap content-between justify-evenly gap-x-[10vw] gap-y-[7vw] md:content-center md:items-center md:justify-center md:flex-nowrap md:w-full md:gap-8">
